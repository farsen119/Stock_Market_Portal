            ...
            <div className="row align-items-center">
              <div className="col-lg-6 mb-5 mb-lg-0">
                ...
                <p className="lead mb-4" style={{
                  ...
                  Leverage machine learning to forecast market trends with unprecedented accuracy.
                </p>
                <div className="d-flex flex-wrap gap-3">
                  <Button 
                    text={<><i className="bi bi-rocket me-2"></i> Get Started</>}
                  ...
                  />
                  <Button 
                    text={<><i className="bi bi-play-circle me-2"></i> Watch Demo</>}
                    class="fw-bold px-4 py-3"
                    url="/demo"
                    style={{
              ...
              <div className="col-lg-6 position-relative">
                <div className="position-relative" style={{
                  ...
                  <div className="ratio ratio-16x9" style={{
                    ...
                    backgroundImage:'url("https://assets.finbold.com/uploads/2024/06/price-chart-of-AAPL-4.png")',
                    // backgroundPosition: 'center',
                    backgroundSize: 'cover',
